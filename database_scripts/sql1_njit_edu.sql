...
--
-- Host: sql1.njit.edu
-- Generation Time: Nov 05, 2024 at 12:47 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AUTO_INCREMENT=30 ;
...
`SportsProductsID` int(11) NOT NULL,
  ...
  `DateCreated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AUTO_INCREMENT=50 ;
...
--
ALTER TABLE `SportsEquipmentCategories`
MODIFY `SportsCategoriesID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `SportsEquipmentProducts`
MODIFY `SportsProductsID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
